  ...
  render() {
    ...
    return (
      <View>
        ...
        <Text style={[centerItems, textStyle, { top: 220, fontSize: 14 }]}>Current Temp.</Text>

        <TimerText
          style={[centerItems, textStyle, { top: 235 }]}
          minutesLong={calculateTemperaturesFromAngle(startAngle)}
        />

        <Text style={[centerItems, textStyle, { top: 500, fontSize: 14 }]}>Desired Temp.</Text>
